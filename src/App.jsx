...
const predefinedRecipes = [
  ...
  },
  {
    ...
    description: "Пушистые панкейки с шоколадной крошкой",
    ingredients: ["Мука", "Яйца", "Молоко", "Шоколадная крошка", "Сахар", "Разрыхлитель"],
    instructions: ["Смешайте сухие ингредиенты", "Добавьте жидкие", "Жарьте на сковороде", "Подавайте с сиропом"],
    cookTime: "20 мин",
    servings: 3,
    difficulty: "Легко",
    mood: "romantic",
  ...
  {
    id: "5",
    name: "Энергетический смузи",
    description: "Витаминный смузи для заряда энергии",
    ingredients: ["Банан", "Шпинат", "Манго", "Кокосовое молоко", "Семена чиа", "Мёд"],
    instructions: ["Поместите все в блендер", "Взбейте до однородности", "Подавайте охлаждённым"],
    cookTime: "5 мин",
    servings: 1,
    difficulty: "Легко",
    mood: "energetic",
